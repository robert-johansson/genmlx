...
**mlx-node is at the heart of GenMLX.** The Rust/NAPI layer (227 @genmlx/core function exports, pinned by the coverage matrix; 5 crates)
...
── Layer C (GPU execution) ──────────────────────────────────────────────
  mlx-node Rust/C++   5 crates; 227 @genmlx/core function exports (coverage-matrix-pinned). MxArray = Arc<lazy graph node>.
