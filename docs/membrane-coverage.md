...
has **222** function exports (2026-06-21 W-B / genmlx-hg7q added the `valueAndGrad` /
...
qwen3_5_moe forward's packed-expert path and odd-bit dequantization). One runtime-only name is `Gradients` (a real class export,
...
| | Count |
|---|---:|
| Function exports (`typeof === "function"`, incl. classes) | **222** |
| → Wrapped in the membrane | **174** |
