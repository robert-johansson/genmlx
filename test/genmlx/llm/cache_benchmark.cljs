...
(if-not (.existsSync fs (str model-dir "/qwen3-0.6b-mlx-bf16/model.safetensors"))
  (println "SKIP llm-cache-benchmark: qwen3-0.6b checkpoint absent at" model-dir)
  (do (println "Loading model...")
    (pr/let
