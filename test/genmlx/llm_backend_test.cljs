(ns genmlx.llm-backend-test
  "Phase 1.2: Test genmlx.llm.backend — model loading, tokenizer, forward pass,
   log-probs, array boundary, and text generation."
...
(p/let
  ...
  (println (str "\n== Phase 1.2: " @pass-count " passed, " @fail-count " failed ==")))
